...
pretty_data[[c("dates", "more_numbers")]] #error - [[]] makes it give you a single column so you can't get it to try and do two columns
pretty_data[[2]][[3]] #gives third entry in the second column 
pretty_data[[2]][3] #gives third entry in the second column 
pretty_data[[2]][c(TRUE, FALSE, TRUE)] #gives the 1st and 3rd values of the second column
pretty_data[[1]][c(1, 2, 1, 2)]  #gives the first, second, first, then second values from the first column
```
